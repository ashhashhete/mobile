...
import com.igenesys.SurveyorActivity;
...
public class SurveyorViewAttachAdapter extends RecyclerView.Adapter<SurveyorViewAttachAdapter.HorizontalViewHolder> {
    ...
    SurveyorViewDeleteAdapterDelete viewDeleteAdapterDelete;

    List<AttachmentItemList> ltt=new ArrayList<>();
    public SurveyorViewAttachAdapter(List<MediaInfoDataModel> newMediaInfoDataModels, int flag, Activity activity, String unit_relative_path, String unitUniqueId, OnViewClickListner onViewClickListner, LocalSurveyDbViewModel localSurveyDbViewModel) {
...
public void onBindViewHolder(HorizontalViewHolder holder, int position) {
    ...
    if (newMediaInfoDataModels != null && !newMediaInfoDataModels.isEmpty() && newMediaInfoDataModels.get(position) != null) {
        ...
        holder.edtypeProof.setText(SurveyorActivity.attrName);
...
//            holder.catDoc.setText(newMediaInfoDataModels.get(position).getDocument_category());
            holder.catDoc.setText(SurveyorActivity.attrName);
            ...
            viewDeleteAdapterDelete=new SurveyorViewDeleteAdapterDelete(newMediaInfoDataModels.get(position),ltt,2,activity,onViewClickListner,newMediaInfoDataModels,position);
