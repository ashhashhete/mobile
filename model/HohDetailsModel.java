...
public class HohDetailsModel {

    String hoh_name, staying_year, aadhar_no, consumer_no, hoh_living_from,
            gender, religion, from_state, mother_tongue, marital_status, education,
            occupation, place_of_work, rent_transit;

    Object globalid, rel_globalid;
    int age;

    public HohDetailsModel(String hoh_name, String staying_year, String aadhar_no, String consumer_no,
                           String hoh_living_from, String gender, String religion, String from_state,
                           String mother_tongue, String marital_status, String education, String occupation,
                           String place_of_work, String rent_transit, Object globalid, Object rel_globalid,
                           int age) {
    ...
    public String getHoh_living_from() {
        return hoh_living_from;
    }

    public void setHoh_living_from(String hoh_living_from) {
        this.hoh_living_from = hoh_living_from;
    }
