...
public class MemberDetailsModel {
    ...
    String gender, relationship, aadhar_no, pan_no, religion, education, occupation,
            type_of_work, place_of_work, rent_transit, member_name, marital_status, from_state,
            mother_tongue;
    Object rel_globalid, globalid;
    int age;

    public MemberDetailsModel(String gender, String relationship, String aadhar_no, String pan_no, String religion,
                              String education, String occupation, String type_of_work, String place_of_work,
                              String rent_transit, String member_name, String marital_status, String from_state,
                              String mother_tongue, Object rel_globalid, Object globalid, int age) {
        this.gender = gender;
